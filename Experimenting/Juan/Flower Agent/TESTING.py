...
for episode in range(num_episodes):
    ...
    while not done:
        ...
        GA_routes,GA_obj,GA_info,GA_time,_ = pIRPgym.Routing.GeneticAlgorithm(purchase,inst_gen,env.t,return_top=False,
                                                                            rd_seed=0,time_limit=10,verbose=False)    # Genetic Algorithm
        # Column Generations
        CG_routes,CG_obj,CG_info,CG_time,CG_cols = pIRPgym.Routing.ColumnGeneration(purchase,inst_gen,env.t,time_limit=100,
